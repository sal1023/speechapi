...
public class BasicHttpRecognizer {
	...
	public String recognize(File soundFile, URL grammarUrl, boolean lmflg) {
	...
	public String recognize(AudioInputStream audioInputStream, Type type, URL grammarUrl, boolean lmflg) {
