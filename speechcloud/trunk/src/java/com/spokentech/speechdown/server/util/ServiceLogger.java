...
public class ServiceLogger {
	...
	public static void logHttpRequest(HttpRequest hr) {
	...
	public static void logRecogRequest(RecogRequest rr,HttpRequest hr) {
	...
	public static void logSynthRequest(SynthRequest sr,HttpRequest hr) {
