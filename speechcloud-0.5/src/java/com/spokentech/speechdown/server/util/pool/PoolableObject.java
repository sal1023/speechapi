...
/**
 * Defines methods required for an object to be pooled using {@link com.spokentech.speechdown.server.util.pool.AbstractPoolableObjectFactory}.
 *
 * @author Niels Godfredsen {@literal <}<a href="mailto:ngodfredsen@users.sourceforge.net">ngodfredsen@users.sourceforge.net</a>{@literal >}
 * @see com.spokentech.speechdown.server.util.pool.AbstractPoolableObjectFactory
 * @see com.spokentech.speechdown.server.util.pool.AbstractPoolableObject
 */
