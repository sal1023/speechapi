    ...
    public Data getData() throws DataProcessingException {
        while (curInBufferSize < blockSizeSamples) {
            ...
            if (data instanceof DataStartSignal) {
                ...
                inBuffer.clear();
                System.out.println("datastart! "+blockSizeSamples+ " "+sampleRate+" "+curInBufferSize);
            }

            if (!(data instanceof DoubleData)) {
            	System.out.println("returning cause not DoubleData "+data.getClass().getCanonicalName());
                return data;
            }
            ...
            System.out.println("Total size is now "+curInBufferSize+ " ,buffer size: "+inBuffer.size());
        }
